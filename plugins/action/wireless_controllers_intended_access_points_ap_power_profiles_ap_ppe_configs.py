...
def _build_action_module():
    ...
    argument_spec.update(
        dict(
            ...
            apPowerProfileId=dict(type="str"),
    ...
    required_if = [
        ("state", "present", ["apPowerProfileId", "id", "networkDeviceId"], True),
        ("state", "absent", ["apPowerProfileId", "id", "networkDeviceId"], True),
    ]
    required_one_of = []
    mutually_exclusive = []
    required_together = []

    class WirelessControllersIntendedAccessPointsApPowerProfilesApPpeConfigs(object):
        def __init__(self, params, catalystcenter):
            self.catalystcenter = catalystcenter
            self.new_object = dict(
                ap_power_profile_id=params.get("apPowerProfileId"),
        ...
        def get_all_params(self, name=None, id=None):
            new_object_params = {}
            new_object_params["ap_power_profile_id"] = self.new_object.get(
                "apPowerProfileId"
            ) or self.new_object.get("ap_power_profile_id")
        ...
        def get_object_by_name(self, name):
            ...
            try:
                items = self.catalystcenter.exec(
                    family="wireless",
                    function="get_configurations_for_ap_ppe_config_feature_on_a_wireless_controller",
        ...
        def get_object_by_id(self, id):
            ...
            try:
                items = self.catalystcenter.exec(
                    family="wireless",
                    function="get_configurations_for_a_specific_instance_of_a_ap_ppe_config_feature_on_a_wireless_controller",
                    params={"id": id},
                )
                if isinstance(items, dict):
                    if "response" in items:
        ...
        def requires_update(self, current_obj):
            ...
            obj_params = [
                ("apPowerProfileId", "ap_power_profile_id"),
        ...
        def create(self):
            result = self.catalystcenter.exec(
                family="wireless",
                function="create_a_new_instance_of_an_intended_ap_ppe_config_feature_on_a_wireless_controller",
        ...
        def update(self):
            ...
            result = self.catalystcenter.exec(
                family="wireless",
                function="update_configurations_for_a_specific_instance_of_an_intended_ap_ppe_config_feature_on_a_wireless_controller",
        ...
        def delete(self):
            ...
            result = self.catalystcenter.exec(
                family="wireless",
                function="delete_configurations_for_a_specific_instance_of_an_intended_ap_ppe_config_feature_on_a_wireless_controller",
    ...
    class ActionModule(ActionBase):
        ...
        def run(self, tmp=None, task_vars=None):
            ...
            obj = WirelessControllersIntendedAccessPointsApPowerProfilesApPpeConfigs(
