...
def _build_action_module():
    ...
    argument_spec.update(
        dict(
            wiredCaptureSettings=dict(type="list"),
            previewDescription=dict(type="str"),
            deploymentOptions=dict(type="dict"),
    ...
    class ActionModule(ActionBase):
        ...
        def get_object(self, params):
            new_object = dict(
                wiredCaptureSettings=params.get("wiredCaptureSettings"),
                previewDescription=params.get("previewDescription"),
                deploymentOptions=params.get("deploymentOptions"),
        ...
        def run(self, tmp=None, task_vars=None):
            ...
            response = catalystcenter.exec(
                family="devices",
                function="deploys_the_wired_capture_without_preview",
                op_modifies=True,
