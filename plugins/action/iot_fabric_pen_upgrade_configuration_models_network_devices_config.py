...
def _build_action_module():
    ...
    class IotFabricPenUpgradeConfigurationModelsNetworkDevicesConfig(object):
        ...
        def get_object_by_id(self, id):
            ...
            try:
                items = self.catalystcenter.exec(
                    ...
                    function="retrieve_the_config_of_network_device_for_en_to_pen_upgrade_configuration_model",
        ...
        def create(self):
            result = self.catalystcenter.exec(
                family="industrial_configuration",
                function="generate_the_config_of_network_device_for_en_to_pen_upgrade_configuration_model",
    ...
    class ActionModule(ActionBase):
        ...
        def run(self, tmp=None, task_vars=None):
            ...
            obj = IotFabricPenUpgradeConfigurationModelsNetworkDevicesConfig(
