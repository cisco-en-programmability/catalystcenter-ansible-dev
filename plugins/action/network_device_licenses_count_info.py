    ...
    class ActionModule(ActionBase):
        ...
        def get_object(self, params):
            new_object = dict(
                ...
                license_mode=params.get("licenseMode"),
                license_type=params.get("licenseType"),
                license_status=params.get("licenseStatus"),
                registration_status=params.get("registrationStatus"),
                authorization_status=params.get("authorizationStatus"),
                auth_codestatus=params.get("authCodeStatus"),
        ...
        def run(self, tmp=None, task_vars=None):
            ...
            response = catalystcenter.exec(
                family="licenses",
                function="retrieves_the_number_of_network_devices",
