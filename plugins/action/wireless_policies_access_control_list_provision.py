...
argument_spec.update(
    dict(
        ...
        localSsids=dict(type="list"),
        flexOrFabricSsids=dict(type="list"),
        ipAclRules=dict(type="list"),
        basicUrls=dict(type="dict"),
        enhancedUrls=dict(type="list"),
        id=dict(type="str"),
    )
)
...
class WirelessPoliciesAccessControlListProvision(object):
    def __init__(self, params, catalystcenter):
        ...
        self.new_object = dict(
            ...
            localSsids=params.get("localSsids"),
            flexOrFabricSsids=params.get("flexOrFabricSsids"),
            ipAclRules=params.get("ipAclRules"),
            basicUrls=params.get("basicUrls"),
            enhancedUrls=params.get("enhancedUrls"),
            id=params.get("id"),
        )
    ...
    def create_params(self):
        ...
        new_object_params["localSsids"] = self.new_object.get("localSsids")
        new_object_params["flexOrFabricSsids"] = self.new_object.get(
            "flexOrFabricSsids"
        )
        new_object_params["ipAclRules"] = self.new_object.get("ipAclRules")
        new_object_params["basicUrls"] = self.new_object.get("basicUrls")
        new_object_params["enhancedUrls"] = self.new_object.get("enhancedUrls")
        return new_object_params
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                family="wireless",
                function="get_ip_and_url_access_control_policies",
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.catalystcenter.exec(
                family="wireless",
                function="get_the_ip_and_url_access_control_policies_by_id",
                params={"id": id},
            )
            if isinstance(items, dict):
                if "response" in items:
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [
            ...
            ("flexOrFabricSsids", "flexOrFabricSsids"),
            ("ipAclRules", "ipAclRules"),
            ("basicUrls", "basicUrls"),
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="wireless",
            function="create_ip_and_url_access_control_policies",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="wireless",
            function="update_ip_and_url_access_control_policies",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="wireless",
            function="delete_ip_and_url_access_control_policies",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = WirelessPoliciesAccessControlListProvision(
