...
def _build_action_module():
    ...
    argument_spec.update(
        dict(
            ...
            id=dict(type="str"),
            connectionAddress=dict(type="dict"),
    ...
    class LocationServersCmxServers(object):
        def __init__(self, params, catalystcenter):
            self.catalystcenter = catalystcenter
            self.new_object = dict(
                id=params.get("id"),
                connectionAddress=params.get("connectionAddress"),
        ...
        def get_all_params(self, name=None, id=None):
            ...
            new_object_params["connection_address"] = self.new_object.get(
                "connectionAddress"
            ) or self.new_object.get("connection_address")
            return new_object_params

        def create_params(self):
            new_object_params = {}
            new_object_params["id"] = self.new_object.get("id")
            new_object_params["connectionAddress"] = self.new_object.get(
                "connectionAddress"
            )
        ...
        def get_object_by_name(self, name):
            ...
            try:
                items = self.catalystcenter.exec(
                    ...
                    function="retrieves_cmx_server_settings",
        ...
        def get_object_by_id(self, id):
            ...
            try:
                items = self.catalystcenter.exec(
                    family="system_settings",
                    function="gets_a_cmx_server_setting",
                    params={"id": id},
                )
                if isinstance(items, dict):
                    if "response" in items:
        ...
        def create(self):
            result = self.catalystcenter.exec(
                family="system_settings",
                function="creates_a_cmx_server_setting",
        ...
        def update(self):
            ...
            result = self.catalystcenter.exec(
                family="system_settings",
                function="updates_a_cmx_server_setting",
        ...
        def delete(self):
            ...
            result = self.catalystcenter.exec(
                family="system_settings",
                function="delete_a_cmx_server_setting",
    ...
    class ActionModule(ActionBase):
        ...
        def run(self, tmp=None, task_vars=None):
            ...
            obj = LocationServersCmxServers(self._task.args, catalystcenter)
