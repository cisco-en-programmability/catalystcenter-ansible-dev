...
def _build_action_module():
    ...
    argument_spec.update(
        dict(
            ...
            violationMessage=dict(type="str"),
    ...
    class ActionModule(ActionBase):
        ...
        def get_object(self, params):
            new_object = dict(
                ...
                sub_types=params.get("subTypes"),
                acknowledgement_status=params.get("acknowledgementStatus"),
                ...
                violation_message=params.get("violationMessage"),
