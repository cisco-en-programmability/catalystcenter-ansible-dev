...
def _build_action_module():
    ...
    argument_spec.update(
        dict(
            accountName=dict(type="str"),
            region=dict(type="str"),
            inviteAdminEmails=dict(type="list"),
        )
    )
    ...
    class ActionModule(ActionBase):
        ...
        def get_object(self, params):
            new_object = dict(
                ...
                inviteAdminEmails=params.get("inviteAdminEmails"),
            )
            return new_object
        ...
        def run(self, tmp=None, task_vars=None):
            ...
            response = catalystcenter.exec(
                ...
                function="activates_existing_cisco_spaces_account_using_cisco_com_credentials",
                op_modifies=True,
