    ...
    def run(self, tmp=None, task_vars=None):
        ...
        if id:
            response = catalystcenter.exec(
                family="devices",
                function="retrieves_the_statistics_of_a_given_wireless_controller",
        ...
        if not id:
            response = catalystcenter.exec(
                family="devices",
                function="retrieves_the_list_of_wireless_controllers_statistics",
                params=self.get_object(self._task.args),
            )
            self._result.update(
                dict(catalystcenter_response=response, dnac_response=response)
