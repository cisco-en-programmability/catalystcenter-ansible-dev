...
def _build_action_module():
    ...
    argument_spec.update(
        dict(
            portChannelInterfaceConfig=dict(type="dict"),
            ethernetInterfaceConfig=dict(type="dict"),
            id=dict(type="str"),
    ...
    class ActionModule(ActionBase):
        ...
        def get_object(self, params):
            new_object = dict(
                portChannelInterfaceConfig=params.get("portChannelInterfaceConfig"),
                ethernetInterfaceConfig=params.get("ethernetInterfaceConfig"),
                id=params.get("id"),
        ...
        def run(self, tmp=None, task_vars=None):
            ...
            response = catalystcenter.exec(
                family="wired",
                function="update_intended_port_configurations",
                op_modifies=True,
