...
def _build_action_module():
    ...
    argument_spec.update(
        dict(
            ...
            implicitAction=dict(type="str"),
            protocolIds=dict(type="list"),
            id=dict(type="str"),
        )
    )
    ...
    class WirelessPoliciesIpAccessControlListsContract(object):
        def __init__(self, params, catalystcenter):
            self.catalystcenter = catalystcenter
            self.new_object = dict(
                name=params.get("name"),
                description=params.get("description"),
                implicitAction=params.get("implicitAction"),
                protocolIds=params.get("protocolIds"),
                id=params.get("id"),
            )
        ...
        def create_params(self):
            ...
            new_object_params["implicitAction"] = self.new_object.get("implicitAction")
            new_object_params["protocolIds"] = self.new_object.get("protocolIds")
            return new_object_params
        ...
        def get_object_by_id(self, id):
            ...
            try:
                items = self.catalystcenter.exec(
                    family="wireless",
                    function="get_the_access_contract_by_id",
                    params={"id": id},
                )
                if isinstance(items, dict):
                    if "response" in items:
        ...
        def create(self):
            result = self.catalystcenter.exec(
                family="wireless",
                function="create_access_contract",
        ...
        def update(self):
            ...
            result = self.catalystcenter.exec(
                family="wireless",
                function="update_access_contract",
        ...
        def delete(self):
            ...
            result = self.catalystcenter.exec(
                family="wireless",
                function="delete_access_contract",
    ...
    class ActionModule(ActionBase):
        ...
        def run(self, tmp=None, task_vars=None):
            ...
            obj = WirelessPoliciesIpAccessControlListsContract(
