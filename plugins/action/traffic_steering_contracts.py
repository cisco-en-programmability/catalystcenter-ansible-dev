...
argument_spec.update(
    dict(
        ...
        policyReferenceCount=dict(type="int"),
        ruleCount=dict(type="int"),
        siteReferenceCount=dict(type="int"),
...
class TrafficSteeringContracts(object):
    def __init__(self, params, catalystcenter):
        ...
        self.new_object = dict(
            ...
            policyReferenceCount=params.get("policyReferenceCount"),
            ruleCount=params.get("ruleCount"),
            siteReferenceCount=params.get("siteReferenceCount"),
    ...
    def create_params(self):
        ...
        new_object_params["policyReferenceCount"] = self.new_object.get(
            "policyReferenceCount"
        )
        new_object_params["ruleCount"] = self.new_object.get("ruleCount")
        new_object_params["siteReferenceCount"] = self.new_object.get(
            "siteReferenceCount"
        )
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                family="security",
                function="retrieve_traffic_steering_contracts",
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.catalystcenter.exec(
                family="security",
                function="retrieve_a_traffic_steering_contract_by_its_id",
                params={"id": id},
            )
            if isinstance(items, dict):
                if "response" in items:
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="security",
            function="creates_a_traffic_steering_contract",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="security",
            function="modify_a_traffic_steering_contract",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="security",
            function="delete_a_traffic_steering_contract",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = TrafficSteeringContracts(self._task.args, catalystcenter)
