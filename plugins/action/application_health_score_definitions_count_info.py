...
def _build_action_module():
    ...
    class ActionModule(ActionBase):
        ...
        def get_object(self, params):
            new_object = dict(
                traffic_class=params.get("trafficClass"),
                include_for_health_score=params.get("includeForHealthScore"),
        ...
        def run(self, tmp=None, task_vars=None):
            ...
            response = catalystcenter.exec(
                family="applications",
                function="get_the_count_of_application_health_score_definitions",
