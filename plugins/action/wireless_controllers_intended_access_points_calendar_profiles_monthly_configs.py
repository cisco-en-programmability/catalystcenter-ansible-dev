...
argument_spec.update(
    dict(
        ...
        calendarProfileId=dict(type="str"),
...
required_if = [
    ("state", "present", ["calendarProfileId", "id", "networkDeviceId"], True),
    ("state", "absent", ["calendarProfileId", "id", "networkDeviceId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class WirelessControllersIntendedAccessPointsCalendarProfilesMonthlyConfigs(object):
    def __init__(self, params, catalystcenter):
        self.catalystcenter = catalystcenter
        self.new_object = dict(
            calendar_profile_id=params.get("calendarProfileId"),
    ...
    def get_all_params(self, name=None, id=None):
        new_object_params = {}
        new_object_params["calendar_profile_id"] = self.new_object.get(
            "calendarProfileId"
        ) or self.new_object.get("calendar_profile_id")
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                family="wireless",
                function="get_configurations_for_monthly_config_feature_on_a_wireless_controller",
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.catalystcenter.exec(
                family="wireless",
                function="get_configurations_for_a_specific_instance_of_a_monthly_config_feature_on_a_wireless_controller_connectivity",
                params={"id": id},
            )
            if isinstance(items, dict):
                if "response" in items:
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [
            ("calendarProfileId", "calendar_profile_id"),
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="wireless",
            function="create_a_new_instance_of_an_intended_monthly_config_feature_on_a_wireless_controller",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="wireless",
            function="delete_configurations_for_a_specific_instance_of_an_intended_monthly_config_feature_on_a_wireless_controller",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = WirelessControllersIntendedAccessPointsCalendarProfilesMonthlyConfigs(
