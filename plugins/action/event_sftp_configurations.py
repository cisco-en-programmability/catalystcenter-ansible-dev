...
class EventSftpConfigurations(object):
    ...
    def get_all_params(self, name=None, id=None):
        new_object_params = {}
        new_object_params["sftp_ids"] = self.new_object.get(
            "sftpIds"
        ) or self.new_object.get("sftp_ids")
    ...
    def create_params(self):
        ...
        new_object_params["path"] = self.new_object.get("path")
        return new_object_params
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                ...
                function="get_sftp_configurations",
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="event_management",
            function="create_a_new_sftp_configuration",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="event_management",
            function="update_an_existing_sftp_configuration",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = EventSftpConfigurations(self._task.args, catalystcenter)
