...
def _build_action_module():
    ...
    argument_spec.update(
        dict(
            apPrimingConfigs=dict(type="dict"),
            apTagConfigs=dict(type="dict"),
            locationConfigs=dict(type="dict"),
    ...
    class ActionModule(ActionBase):
        ...
        def get_object(self, params):
            new_object = dict(
                apPrimingConfigs=params.get("apPrimingConfigs"),
                apTagConfigs=params.get("apTagConfigs"),
                locationConfigs=params.get("locationConfigs"),
        ...
        def run(self, tmp=None, task_vars=None):
            ...
            response = catalystcenter.exec(
                family="wireless",
                function="update_configurations_for_an_intended_tag_mapping_feature_on_a_wireless_controller",
                op_modifies=True,
