...
class PathTraces(object):
    ...
    def create_params(self):
        ...
        new_object_params["destinationPort"] = self.new_object.get("destinationPort")
        ...
        new_object_params["protocol"] = self.new_object.get("protocol")
        new_object_params["sourceIpAddress"] = self.new_object.get("sourceIpAddress")
        new_object_params["sourcePort"] = self.new_object.get("sourcePort")
        new_object_params["sourceMacAddress"] = self.new_object.get("sourceMacAddress")
        return new_object_params
