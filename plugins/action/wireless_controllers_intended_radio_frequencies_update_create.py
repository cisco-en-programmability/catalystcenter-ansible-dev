...
def _build_action_module():
    ...
    argument_spec.update(
        dict(
            multiBssidProfiles=dict(type="dict"),
            radioProfiles=dict(type="dict"),
            rfProfiles=dict(type="dict"),
            rfTags=dict(type="dict"),
            urwbProfiles=dict(type="dict"),
    ...
    class ActionModule(ActionBase):
        ...
        def get_object(self, params):
            new_object = dict(
                multiBssidProfiles=params.get("multiBssidProfiles"),
                radioProfiles=params.get("radioProfiles"),
                rfProfiles=params.get("rfProfiles"),
                rfTags=params.get("rfTags"),
                urwbProfiles=params.get("urwbProfiles"),
        ...
        def run(self, tmp=None, task_vars=None):
            ...
            response = catalystcenter.exec(
                family="wireless",
                function="update_configurations_for_an_intended_radio_frequency_feature_on_a_wireless_controller",
                op_modifies=True,
