...
def _build_action_module():
    ...
    argument_spec.update(
        dict(
            ...
            enableRemoteTeleworker=dict(type="bool"),
            id=dict(type="str"),
        )
    )

    required_if = [
        ("state", "present", ["id", "areaId", "enableRemoteTeleworker"], True),
    ]
    required_one_of = []
    mutually_exclusive = []
    required_together = []

    class WirelessSettingsRemoteTeleworkers(object):
        def __init__(self, params, catalystcenter):
            self.catalystcenter = catalystcenter
            self.new_object = dict(
                areaId=params.get("areaId"),
                enableRemoteTeleworker=params.get("enableRemoteTeleworker"),
                id=params.get("id"),
            )
        ...
        def create_params(self):
            new_object_params = {}
            new_object_params["areaId"] = self.new_object.get("areaId")
            new_object_params["enableRemoteTeleworker"] = self.new_object.get(
        ...
        def get_object_by_name(self, name):
            ...
            try:
                items = self.catalystcenter.exec(
                    family="wireless",
                    function="get_remote_teleworker_enabled_areas",
        ...
        def requires_update(self, current_obj):
            ...
            obj_params = [
                ("areaId", "areaId"),
                ("enableRemoteTeleworker", "enableRemoteTeleworker"),
                ("id", "id"),
            ]
        ...
        def create(self):
            result = self.catalystcenter.exec(
                family="wireless",
                function="create_remote_teleworker_area",
        ...
        def update(self):
            ...
            result = self.catalystcenter.exec(
                family="wireless",
                function="update_remote_teleworker_area",
    ...
    class ActionModule(ActionBase):
        ...
        def run(self, tmp=None, task_vars=None):
            ...
            obj = WirelessSettingsRemoteTeleworkers(self._task.args, catalystcenter)
