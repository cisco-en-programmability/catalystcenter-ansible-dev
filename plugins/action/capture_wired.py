...
class CaptureWired(object):
    ...
    def get_all_params(self, name=None, id=None):
        new_object_params = {}
        new_object_params["capture_status"] = self.new_object.get(
            "captureStatus"
        ) or self.new_object.get("capture_status")
        new_object_params["offset"] = self.new_object.get("offset")
        new_object_params["limit"] = self.new_object.get("limit")
        new_object_params["switch_id"] = self.new_object.get(
            "switchId"
        ) or self.new_object.get("switch_id")
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                family="devices",
                function="retrieves_wired_capture_sessions",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="devices",
            function="remove_the_wired_capture_configuration",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = CaptureWired(self._task.args, catalystcenter)
