...
def _build_action_module():
    ...
    class SitesWirelessSettingsSsids(object):
        ...
        def create_params(self):
            ...
            new_object_params["isLoadBalancingEnabledForAuthGroup"] = (
                self.new_object.get("isLoadBalancingEnabledForAuthGroup")
            )
            new_object_params["acctServers"] = self.new_object.get("acctServers")
            new_object_params["isLoadBalancingEnabledForAcctGroup"] = (
                self.new_object.get("isLoadBalancingEnabledForAcctGroup")
            )
