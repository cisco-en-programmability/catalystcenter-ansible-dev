...
class WirelessPoliciesIpAccessControlListsProtocol(object):
    def __init__(self, params, catalystcenter):
        ...
        self.new_object = dict(
            ...
            ignoreConflict=params.get("ignoreConflict"),
            id=params.get("id"),
        )
    ...
    def create_params(self):
        ...
        new_object_params["ports"] = self.new_object.get("ports")
        new_object_params["ignoreConflict"] = self.new_object.get("ignoreConflict")
        return new_object_params
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.catalystcenter.exec(
                family="wireless", function="get_the_protocol_by_id", params={"id": id}
            )
            if isinstance(items, dict):
                if "response" in items:
                    items = items.get("response")
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = WirelessPoliciesIpAccessControlListsProtocol(
