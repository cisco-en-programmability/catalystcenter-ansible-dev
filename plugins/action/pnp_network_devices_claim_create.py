...
argument_spec.update(
    dict(
        ...
        apZone=dict(type="str"),
        cablingScheme=dict(type="str"),
        topOfStackSerialNumber=dict(type="str"),
        sensorProfile=dict(type="str"),
        staticIpAddress=dict(type="dict"),
        subnetMask=dict(type="str"),
        prefix=dict(type="int"),
        gateway=dict(type="dict"),
        vlanId=dict(type="int"),
        ipInterfaceName=dict(type="str"),
        svlConfig=dict(type="dict"),
        pushDeviceIdCertificate=dict(type="bool"),
        id=dict(type="str"),
    )
)
...
class ActionModule(ActionBase):
    ...
    def get_object(self, params):
        new_object = dict(
            ...
            apZone=params.get("apZone"),
            cablingScheme=params.get("cablingScheme"),
            topOfStackSerialNumber=params.get("topOfStackSerialNumber"),
            sensorProfile=params.get("sensorProfile"),
            staticIpAddress=params.get("staticIpAddress"),
            subnetMask=params.get("subnetMask"),
            prefix=params.get("prefix"),
            gateway=params.get("gateway"),
            vlanId=params.get("vlanId"),
            ipInterfaceName=params.get("ipInterfaceName"),
            svlConfig=params.get("svlConfig"),
            pushDeviceIdCertificate=params.get("pushDeviceIdCertificate"),
            id=params.get("id"),
        )
        return new_object
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        response = catalystcenter.exec(
            ...
            function="claim_a_device_in_pnp",
            op_modifies=True,
