...
class ExcludedWirelessClients(object):
    ...
    def update_by_id_params(self):
        ...
        new_object_params["impactedWlcs"] = self.new_object.get("impactedWlcs")
        new_object_params["id"] = self.new_object.get("id")
        return new_object_params
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                family="wireless",
                function="get_all_excluded_clients",
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.catalystcenter.exec(
                family="wireless",
                function="get_excluded_client_by_id",
                params={"id": id},
            )
            if isinstance(items, dict):
                if "response" in items:
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="wireless",
            function="modify_excluded_client",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="wireless",
            function="delete_excluded_client",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = ExcludedWirelessClients(self._task.args, catalystcenter)
