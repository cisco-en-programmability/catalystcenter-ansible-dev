...
def _build_action_module():
    ...
    argument_spec.update(
        dict(
            ...
            onboardingState=dict(type="str"),
            hostname=dict(type="str"),
            pid=dict(type="str"),
            siteNameHierarchy=dict(type="str"),
            source=dict(type="str"),
            smartAccount=dict(type="str"),
            virtualAccount=dict(type="str"),
            imageVersion=dict(type="str"),
            contactedStatus=dict(type="str"),
            svlClaimable=dict(type="bool"),
            svlDevice=dict(type="bool"),
    ...
    class ActionModule(ActionBase):
        ...
        def get_object(self, params):
            new_object = dict(
                ...
                onboarding_state=params.get("onboardingState"),
                hostname=params.get("hostname"),
                pid=params.get("pid"),
                site_name_hierarchy=params.get("siteNameHierarchy"),
                source=params.get("source"),
                smart_account=params.get("smartAccount"),
                virtual_account=params.get("virtualAccount"),
                image_version=params.get("imageVersion"),
                contacted_status=params.get("contactedStatus"),
                svl_claimable=params.get("svlClaimable"),
                svl_device=params.get("svlDevice"),
