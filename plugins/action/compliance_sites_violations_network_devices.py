...
required_if = [
    ("state", "present", ["networkDeviceId", "siteId", "violationId"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class ComplianceSitesViolationsNetworkDevices(object):
    ...
    def get_all_params(self, name=None, id=None):
        ...
        new_object_params["management_address"] = self.new_object.get(
            "managementAddress"
        ) or self.new_object.get("management_address")
        ...
        new_object_params["violation_id"] = self.new_object.get(
            "violationId"
        ) or self.new_object.get("violation_id")
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                family="compliance",
                function="retrieve_the_devices_with_the_violation",
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.catalystcenter.exec(
                family="compliance",
                function="retrieve_a_device_with_the_violation",
    ...
    def update(self):
        ...
        id = id or self.new_object.get("network_device_id")
        name = self.new_object.get("name")
        result = None
        if not id:
            ...
            if prev_obj_name:
                ...
                id_ = id_ or prev_obj_name.get("networkDeviceId")
            if id_:
                self.new_object.update(dict(network_device_id=id_))
        result = self.catalystcenter.exec(
            family="compliance",
            function="acknowledge_or_unacknowledge_compliance_violation",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = ComplianceSitesViolationsNetworkDevices(self._task.args, catalystcenter)
