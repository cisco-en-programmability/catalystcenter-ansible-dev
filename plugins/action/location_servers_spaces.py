...
def _build_action_module():
    ...
    class LocationServersSpaces(object):
        ...
        def get_object_by_name(self, name):
            ...
            try:
                items = self.catalystcenter.exec(
                    ...
                    function="retrieves_cisco_spaces_settings",
        ...
        def delete(self):
            ...
            result = self.catalystcenter.exec(
                family="system_settings",
                function="deletes_cisco_spaces_settings",
    ...
    class ActionModule(ActionBase):
        ...
        def run(self, tmp=None, task_vars=None):
            ...
            obj = LocationServersSpaces(self._task.args, catalystcenter)
