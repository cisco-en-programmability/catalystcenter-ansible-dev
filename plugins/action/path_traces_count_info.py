...
def _build_action_module():
    ...
    argument_spec.update(
        dict(
            ...
            destinationPort=dict(type="float"),
            greaterThanCreateTime=dict(type="float"),
            lessThanCreateTime=dict(type="float"),
    ...
    class ActionModule(ActionBase):
        ...
        def get_object(self, params):
            new_object = dict(
                ...
                source_ip_address=params.get("sourceIpAddress"),
                source_mac_address=params.get("sourceMacAddress"),
                destination_ip_address=params.get("destinationIpAddress"),
                destination_mac_address=params.get("destinationMacAddress"),
                source_port=params.get("sourcePort"),
                destination_port=params.get("destinationPort"),
                greater_than_create_time=params.get("greaterThanCreateTime"),
                less_than_create_time=params.get("lessThanCreateTime"),
        ...
        def run(self, tmp=None, task_vars=None):
            ...
            response = catalystcenter.exec(
                family="path_trace",
                function="retrieves_the_count_of_path_traces_matching_filter_criteria",
