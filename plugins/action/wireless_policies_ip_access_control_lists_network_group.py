...
class WirelessPoliciesIpAccessControlListsNetworkGroup(object):
    def __init__(self, params, catalystcenter):
        self.catalystcenter = catalystcenter
        self.new_object = dict(
            name=params.get("name"),
            description=params.get("description"),
            ipAddresses=params.get("ipAddresses"),
            id=params.get("id"),
        )
    ...
    def create_params(self):
        ...
        new_object_params["ipAddresses"] = self.new_object.get("ipAddresses")
        return new_object_params
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                family="wireless",
                function="get_ip_network_groups",
    ...
    def get_object_by_id(self, id):
        ...
        try:
            items = self.catalystcenter.exec(
                family="wireless",
                function="get_the_ip_network_groups_by_id",
                params={"id": id},
            )
            if isinstance(items, dict):
                if "response" in items:
    ...
    def create(self):
        result = self.catalystcenter.exec(
            family="wireless",
            function="create_ip_network_groups",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="wireless",
            function="update_ip_network_groups",
    ...
    def delete(self):
        ...
        result = self.catalystcenter.exec(
            family="wireless",
            function="delete_ip_network_groups",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = WirelessPoliciesIpAccessControlListsNetworkGroup(
