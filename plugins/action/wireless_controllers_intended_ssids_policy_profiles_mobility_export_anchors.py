...
def _build_action_module():
    ...
    class WirelessControllersIntendedSsidsPolicyProfilesMobilityExportAnchors(object):
        ...
        def get_object_by_name(self, name):
            ...
            try:
                items = self.catalystcenter.exec(
                    family="wireless",
                    function="get_configurations_for_mobility_export_anchor_feature_on_a_wireless_controller",
        ...
        def get_object_by_id(self, id):
            ...
            try:
                items = self.catalystcenter.exec(
                    family="wireless",
                    function="get_configurations_for_a_specific_instance_of_a_mobility_export_anchor_feature_on_a_wireless_controller",
                    params={"id": id},
                )
                if isinstance(items, dict):
                    if "response" in items:
        ...
        def create(self):
            result = self.catalystcenter.exec(
                family="wireless",
                function="create_a_new_instance_of_an_intended_mobility_export_anchor_feature_on_a_wireless_controller",
        ...
        def update(self):
            ...
            result = self.catalystcenter.exec(
                family="wireless",
                function="update_configurations_for_a_specific_instance_of_an_intended_mobility_export_anchor_feature_on_a_wireless_controller",
        ...
        def delete(self):
            ...
            result = self.catalystcenter.exec(
                family="wireless",
                function="delete_configurations_for_a_specific_instance_of_an_intended_mobility_export_anchor_feature_on_a_wireless_controller",
    ...
    class ActionModule(ActionBase):
        ...
        def run(self, tmp=None, task_vars=None):
            ...
            obj = WirelessControllersIntendedSsidsPolicyProfilesMobilityExportAnchors(
