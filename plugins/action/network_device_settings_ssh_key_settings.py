...
argument_spec.update(
    dict(
        ...
        autoAcceptSshKeys=dict(type="bool"),
    )
)
...
class NetworkDeviceSettingsSshKeySettings(object):
    def __init__(self, params, catalystcenter):
        self.catalystcenter = catalystcenter
        self.new_object = dict(
            autoAcceptSshKeys=params.get("autoAcceptSshKeys"),
        )
    ...
    def update_all_params(self):
        new_object_params = {}
        new_object_params["autoAcceptSshKeys"] = self.new_object.get(
            "autoAcceptSshKeys"
        )
        return new_object_params
    ...
    def get_object_by_name(self, name):
        ...
        try:
            items = self.catalystcenter.exec(
                family="devices",
                function="get_global_settings_value_for_new_ssh_key_handling",
    ...
    def update(self):
        ...
        result = self.catalystcenter.exec(
            family="devices",
            function="configure_global_settings_for_ssh_key_handling",
...
class ActionModule(ActionBase):
    ...
    def run(self, tmp=None, task_vars=None):
        ...
        obj = NetworkDeviceSettingsSshKeySettings(self._task.args, catalystcenter)
