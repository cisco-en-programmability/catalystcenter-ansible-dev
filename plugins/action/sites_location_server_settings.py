...
def _build_action_module():
    ...
    class SitesLocationServerSettings(object):
        def __init__(self, params, catalystcenter):
            self.catalystcenter = catalystcenter
            self.new_object = dict(
                locationServer=params.get("locationServer"),
                id=params.get("id"),
            )
        ...
        def update_all_params(self):
            new_object_params = {}
            new_object_params["locationServer"] = self.new_object.get("locationServer")
        ...
        def get_object_by_name(self, name):
            ...
            try:
                items = self.catalystcenter.exec(
                    ...
                    function="retrieve_location_server_settings_for_a_site_cisco_spaces_or_cmx_server",
        ...
        def update(self):
            ...
            result = self.catalystcenter.exec(
                family="network_settings",
                function="set_location_server_settings_for_a_site_cisco_spaces_or_cmx_server",
    ...
    class ActionModule(ActionBase):
        ...
        def run(self, tmp=None, task_vars=None):
            ...
            obj = SitesLocationServerSettings(self._task.args, catalystcenter)
