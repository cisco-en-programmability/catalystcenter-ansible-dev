...
def _build_action_module():
    ...
    class CaptureWiredConfigurationModelsNetworkDevicesConfig(object):
        ...
        def get_object_by_id(self, id):
            ...
            try:
                items = self.catalystcenter.exec(
                    family="devices",
                    function="retrieves_the_devices_clis_in_preview",
        ...
        def create(self):
            result = self.catalystcenter.exec(
                family="devices",
                function="generates_the_devices_clis_in_preview",
    ...
    class ActionModule(ActionBase):
        ...
        def run(self, tmp=None, task_vars=None):
            ...
            obj = CaptureWiredConfigurationModelsNetworkDevicesConfig(
