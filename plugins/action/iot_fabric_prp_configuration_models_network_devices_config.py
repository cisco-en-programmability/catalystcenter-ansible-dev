...
def _build_action_module():
    ...
    class IotFabricPrpConfigurationModelsNetworkDevicesConfig(object):
        ...
        def get_object_by_id(self, id):
            ...
            try:
                items = self.catalystcenter.exec(
                    ...
                    function="retrieve_generated_prp_configuration_for_the_given_network_device_and_prp_configuration_model",
        ...
        def create(self):
            result = self.catalystcenter.exec(
                family="industrial_configuration",
                function="generate_prp_configuration_for_the_given_network_device_and_prp_configuration_model",
    ...
    class ActionModule(ActionBase):
        ...
        def run(self, tmp=None, task_vars=None):
            ...
            obj = IotFabricPrpConfigurationModelsNetworkDevicesConfig(
