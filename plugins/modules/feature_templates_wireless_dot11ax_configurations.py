...
seealso:
  ...
  - name: Cisco Catalyst Center documentation for Wireless DeleteDot11axConfigurationFeatureTemplate
  ...
  - name: Cisco Catalyst Center documentation for Wireless UpdateDot11axConfigurationFeatureTemplate
