...
description:
  - Get all Energy Sites Count.
  - Retrieves the total count of sites that provide energy data, filtered.
version_added: '2.2.0'
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Sites CountSitesEnergy
