...
DOCUMENTATION = r"""
---
module: settings_ap_pnp_location
short_description: Resource module for Settings Ap Pnp Location
description:
  - Manage operation update of the resource Settings Ap Pnp Location. - > Enable or disable the AP PnP Location setting in
    the system.Once the AP PnP Location Setting is enabled, the Access Point's assigned Site name will be configured as the
    AP Location during the PnP Claim process. This applies only during the PnP onboarding process and not during any subsequent
    provisioning dayN .
...
---
- name: Update all
  cisco.catalystcenter.settings_ap_pnp_location:
