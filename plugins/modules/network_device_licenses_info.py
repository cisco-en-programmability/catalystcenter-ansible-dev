...
DOCUMENTATION = r"""
---
module: network_device_licenses_info
short_description: Information module for Network Device Licenses
description:
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Licenses RetrievesLicenseDetailsOfANetworkDevice
    description: Complete reference of the RetrievesLicenseDetailsOfANetworkDevice API.
    link: https://developer.cisco.com/docs/dna-center/#!retrieves-license-details-of-a-network-device
  - name: Cisco Catalyst Center documentation for Licenses RetrievesLicenseDetailsOfNetworkDevices
    description: Complete reference of the RetrievesLicenseDetailsOfNetworkDevices API.
    link: https://developer.cisco.com/docs/dna-center/#!retrieves-license-details-of-network-devices
notes:
  - SDK Method used are
    licenses.Licenses.retrieves_license_details_of_a_network_device,
    licenses.Licenses.retrieves_license_details_of_network_devices,
  - Paths used are
    get /dna/intent/api/v1/networkDeviceLicenses,
    get /dna/intent/api/v1/networkDeviceLicenses/{id},
"""
