...
DOCUMENTATION = r"""
---
module: switches_configs_deployed_layer3_info
short_description: Information module for Switches Configs Deployed Layer3
description:
  - Get Switches Configs Deployed Layer3 by id. - > Returns deployed configuration entries for the specified layer 3 feature
    on the switch. The device config learning must have enabled for the switch using the API /dna/campus/api/v1/switches/configs/deployed/enable
...
options:
  ...
  feature:
    description:
      - >
        Feature path parameter. Name of the feature to retrieve Layer 3 configuration for. The API
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Wired GetDeployedLayer3Configurations
    description: Complete reference of the GetDeployedLayer3Configurations API.
    link: https://developer.cisco.com/docs/dna-center/#!get-deployed-layer-3-configurations
notes:
  - SDK Method used are
    wired.Wired.get_deployed_layer3_configurations,
  - Paths used are
    get /dna/campus/api/v1/switches/{id}/configs/deployed/layer3/{feature},
"""

EXAMPLES = r"""
---
- name: Get Switches Configs Deployed Layer3 by id
  cisco.catalystcenter.switches_configs_deployed_layer3_info:
