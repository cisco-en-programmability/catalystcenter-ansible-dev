...
DOCUMENTATION = r"""
---
module: wireless_controllers_intended_radio_frequencies_rf_profiles_rf_dca_allowed_channel_configs_info
short_description: Information module for Wireless Controllers Intended Radio Frequencies Rf Profiles Rf Dca Allowed Channel
  Configs
description:
  - Get all Wireless Controllers Intended Radio Frequencies Rf Profiles Rf Dca Allowed Channel Configs.
  - Get Wireless Controllers Intended Radio Frequencies Rf Profiles Rf Dca Allowed Channel Configs by id. - > This API operation
...
notes:
  - SDK Method used are
    wireless.Wireless.get_configurations_for_a_specific_instance_of_a_rf_dca_allowed_channel_config_feature_on_a_wireless_controller_connectivity,
    wireless.Wireless.get_configurations_for_rf_dca_allowed_channel_config_feature_on_a_wireless_controller,
  - Paths used are
    get /dna/campus/api/v1/wirelessControllers/{networkDeviceId}/intended/radioFrequencies/rfProfiles/{rfProfileId}/rfDcaAllowedChannelConfigs,
    get /dna/campus/api/v1/wirelessControllers/{networkDeviceId}/intended/radioFrequencies/rfProfiles/{rfProfileId}/rfDcaAllowedChannelConfigs/{id},
"""

EXAMPLES = r"""
---
- name: Get all Wireless Controllers Intended Radio Frequencies Rf Profiles Rf Dca Allowed Channel Configs
  cisco.catalystcenter.wireless_controllers_intended_radio_frequencies_rf_profiles_rf_dca_allowed_channel_configs_info:
  ...
  register: result
- name: Get Wireless Controllers Intended Radio Frequencies Rf Profiles Rf Dca Allowed Channel Configs by id
  cisco.catalystcenter.wireless_controllers_intended_radio_frequencies_rf_profiles_rf_dca_allowed_channel_configs_info:
    catalystcenter_host: "{{catalystcenter_host}}"
    catalystcenter_username: "{{catalystcenter_username}}"
    catalystcenter_password: "{{catalystcenter_password}}"
