...
DOCUMENTATION = r"""
---
module: wireless_controllers_deployed_flexes_flex_profiles_umbrella_profile_configs_info
short_description: Information module for Wireless Controllers Deployed Flexes Flex Profiles Umbrella Profile Configs
description:
  - Get all Wireless Controllers Deployed Flexes Flex Profiles Umbrella Profile Configs.
  - Get Wireless Controllers Deployed Flexes Flex Profiles Umbrella Profile Configs by id. - > This API operation returns
...
notes:
  - SDK Method used are
    wireless.Wireless.get_configurations_for_a_specific_instance_of_a_umbrella_profile_config_feature_on_a_wireless_controller_connectivity,
    wireless.Wireless.get_configurations_for_flex_feature_on_a_wireless_controller_umbrella_profile_configs,
  - Paths used are
    get /dna/campus/api/v1/wirelessControllers/{networkDeviceId}/deployed/flexes/flexProfiles/{flexProfileId}/umbrellaProfileConfigs,
    get /dna/campus/api/v1/wirelessControllers/{networkDeviceId}/deployed/flexes/flexProfiles/{flexProfileId}/umbrellaProfileConfigs/{id},
"""

EXAMPLES = r"""
---
- name: Get all Wireless Controllers Deployed Flexes Flex Profiles Umbrella Profile Configs
  cisco.catalystcenter.wireless_controllers_deployed_flexes_flex_profiles_umbrella_profile_configs_info:
  ...
  register: result
- name: Get Wireless Controllers Deployed Flexes Flex Profiles Umbrella Profile Configs by id
  cisco.catalystcenter.wireless_controllers_deployed_flexes_flex_profiles_umbrella_profile_configs_info:
    catalystcenter_host: "{{catalystcenter_host}}"
    catalystcenter_username: "{{catalystcenter_username}}"
    catalystcenter_password: "{{catalystcenter_password}}"
