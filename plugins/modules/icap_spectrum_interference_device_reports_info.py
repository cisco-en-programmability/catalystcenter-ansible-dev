...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Sensors RetrievesTheSpectrumInterferenceDevicesReportsSentByWLCForProvidedAPMac
...
notes:
  - SDK Method used are
    sensors.Sensors.retrieves_the_spectrum_interference_devices_reports_sent_by_wlc_for_provided_ap_mac,
  - Paths used are
