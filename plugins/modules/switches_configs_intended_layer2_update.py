...
DOCUMENTATION = r"""
---
module: switches_configs_intended_layer2_update
short_description: Resource module for Switches Configs Intended Layer2 Update
description:
  - Manage operation update of the resource Switches Configs Intended Layer2 Update. - > This API updates the configurations
...
options:
  cdpConfig:
    ...
    suboptions:
      items:
        description: Switches Configs Intended Layer2 Update's items.
        elements: dict
        suboptions:
          configType:
      ...
      items:
        ...
        suboptions:
          ...
          igmpSnoopingQuerierEntry:
            ...
            suboptions:
              configType:
                description: Switches Configs Intended Layer2 Update's configType.
                type: str
              items:
                description: Switches Configs Intended Layer2 Update's items.
                elements: dict
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Wired UpdateIntendedLayer2Configurations
    description: Complete reference of the UpdateIntendedLayer2Configurations API.
    link: https://developer.cisco.com/docs/dna-center/#!update-intended-layer-2-configurations
notes:
  - SDK Method used are
    wired.Wired.update_intended_layer2_configurations,
  - Paths used are
    put /dna/campus/api/v1/switches/{id}/configs/intended/layer2/{feature},
"""

EXAMPLES = r"""
---
- name: Update by id
  cisco.catalystcenter.switches_configs_intended_layer2_update:
