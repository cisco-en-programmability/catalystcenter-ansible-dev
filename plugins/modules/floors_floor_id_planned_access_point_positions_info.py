...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Site Design GetPlannedAccessPointsPositions
    description: Complete reference of the GetPlannedAccessPointsPositions API.
