...
short_description: Information module for Security Service Insertion Summaries
description:
  ...
  order:
    description:
      - >
        ...
        descending (desc). If no value is specified, the default order is ascending (asc).
    type: str
  limit:
    description:
      - >
        Limit query parameter. Maximum number of records to return. Default value is 500, minimum value is 1 and
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for SDA SecurityServiceInsertionSummary
    description: Complete reference of the SecurityServiceInsertionSummary API.
