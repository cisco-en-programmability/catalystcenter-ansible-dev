...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for SDA ReadListOfVirtualNetworksWithTheirHealthSummary
  ...
  - name: Cisco Catalyst Center documentation for SDA ReadVirtualNetworkWithItsHealthSummaryFromId
