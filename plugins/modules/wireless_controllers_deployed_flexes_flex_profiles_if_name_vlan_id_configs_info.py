...
DOCUMENTATION = r"""
---
module: wireless_controllers_deployed_flexes_flex_profiles_if_name_vlan_id_configs_info
short_description: Information module for Wireless Controllers Deployed Flexes Flex Profiles If Name Vlan Id Configs
description:
  - Get all Wireless Controllers Deployed Flexes Flex Profiles If Name Vlan Id Configs.
  - Get Wireless Controllers Deployed Flexes Flex Profiles If Name Vlan Id Configs by id. - > This API operation returns the
...
notes:
  - SDK Method used are
    wireless.Wireless.get_configurations_for_a_specific_instance_of_a_if_name_vlan_id_config_feature_on_a_wireless_controller_connectivity,
    wireless.Wireless.get_configurations_for_flex_feature_on_a_wireless_controller,
  - Paths used are
    get /dna/campus/api/v1/wirelessControllers/{networkDeviceId}/deployed/flexes/flexProfiles/{flexProfileId}/ifNameVlanIdConfigs,
    get /dna/campus/api/v1/wirelessControllers/{networkDeviceId}/deployed/flexes/flexProfiles/{flexProfileId}/ifNameVlanIdConfigs/{id},
"""

EXAMPLES = r"""
---
- name: Get all Wireless Controllers Deployed Flexes Flex Profiles If Name Vlan Id Configs
  cisco.catalystcenter.wireless_controllers_deployed_flexes_flex_profiles_if_name_vlan_id_configs_info:
  ...
  register: result
- name: Get Wireless Controllers Deployed Flexes Flex Profiles If Name Vlan Id Configs by id
  cisco.catalystcenter.wireless_controllers_deployed_flexes_flex_profiles_if_name_vlan_id_configs_info:
    catalystcenter_host: "{{catalystcenter_host}}"
    catalystcenter_username: "{{catalystcenter_username}}"
    catalystcenter_password: "{{catalystcenter_password}}"
