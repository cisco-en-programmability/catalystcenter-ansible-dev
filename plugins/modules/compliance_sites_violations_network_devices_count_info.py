...
DOCUMENTATION = r"""
---
module: compliance_sites_violations_network_devices_count_info
short_description: Information module for Compliance Sites Violations Network Devices Count
description:
  - Get all Compliance Sites Violations Network Devices Count.
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Compliance RetrieveTheCountOfNetworkDevices
    description: Complete reference of the RetrieveTheCountOfNetworkDevices API.
    link: https://developer.cisco.com/docs/dna-center/#!retrieve-the-count-of-network-devices
notes:
  - SDK Method used are
    compliance.Compliance.retrieve_the_count_of_network_devices,
  - Paths used are
    get /dna/intent/api/v1/compliance/sites/{siteId}/violations/{violationId}/networkDevices/count,
"""

EXAMPLES = r"""
---
- name: Get all Compliance Sites Violations Network Devices Count
  cisco.catalystcenter.compliance_sites_violations_network_devices_count_info:
