...
seealso:
  ...
  - name: Cisco Catalyst Center documentation for Devices DeletePlannedAccessPointForFloor
  ...
  - name: Cisco Catalyst Center documentation for Devices UpdatePlannedAccessPointForFloor
