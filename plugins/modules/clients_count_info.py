...
description:
  ...
  - Retrieves the number of clients by applying basic filtering. For detailed.
version_added: '1.0.0'
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Clients RetrievesTheTotalCountOfClientsByApplyingBasicFiltering
