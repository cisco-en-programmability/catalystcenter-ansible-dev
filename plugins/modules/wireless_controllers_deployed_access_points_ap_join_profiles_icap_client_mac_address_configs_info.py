...
DOCUMENTATION = r"""
---
module: wireless_controllers_deployed_access_points_ap_join_profiles_icap_client_mac_address_configs_info
short_description: Information module for Wireless Controllers Deployed Access Points Ap Join Profiles Icap Client Mac Address
  Configs
description:
  - Get all Wireless Controllers Deployed Access Points Ap Join Profiles Icap Client Mac Address Configs.
  - Get Wireless Controllers Deployed Access Points Ap Join Profiles Icap Client Mac Address Configs by id. - > This API operation
...
notes:
  - SDK Method used are
    wireless.Wireless.get_configurations_for_a_specific_instance_of_a_icap_client_mac_address_config_feature_on_a_wireless_controller_connectivity,
    wireless.Wireless.get_configurations_for_access_point_feature_on_a_wireless_controller_connectivity,
  - Paths used are
    get /dna/campus/api/v1/wirelessControllers/{networkDeviceId}/deployed/accessPoints/apJoinProfiles/{apJoinProfileId}/icapClientMacAddressConfigs,
    get /dna/campus/api/v1/wirelessControllers/{networkDeviceId}/deployed/accessPoints/apJoinProfiles/{apJoinProfileId}/icapClientMacAddressConfigs/{id},
"""

EXAMPLES = r"""
---
- name: Get all Wireless Controllers Deployed Access Points Ap Join Profiles Icap Client Mac Address Configs
  cisco.catalystcenter.wireless_controllers_deployed_access_points_ap_join_profiles_icap_client_mac_address_configs_info:
  ...
  register: result
- name: Get Wireless Controllers Deployed Access Points Ap Join Profiles Icap Client Mac Address Configs by id
  cisco.catalystcenter.wireless_controllers_deployed_access_points_ap_join_profiles_icap_client_mac_address_configs_info:
    catalystcenter_host: "{{catalystcenter_host}}"
    catalystcenter_username: "{{catalystcenter_username}}"
    catalystcenter_password: "{{catalystcenter_password}}"
