...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Device Onboarding (PnP) GetDeviceById
    description: Complete reference of the GetDeviceById API.
    link: https://developer.cisco.com/docs/dna-center/#!get-device-by-id
  - name: Cisco Catalyst Center documentation for Device Onboarding (PnP) GetDeviceListSiteManagement
