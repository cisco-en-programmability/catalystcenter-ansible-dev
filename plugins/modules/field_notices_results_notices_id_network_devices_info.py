...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Compliance GetFieldNoticeNetworkDeviceForTheNoticeByNetworkDeviceId
  ...
  - name: Cisco Catalyst Center documentation for Compliance GetFieldNoticeNetworkDevicesForTheNotice
