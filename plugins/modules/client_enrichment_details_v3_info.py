...
DOCUMENTATION = r"""
---
module: client_enrichment_details_v3_info
short_description: Information module for Client Enrichment Details V3
description:
  - Get all Client Enrichment Details V3. - > Enriches a given network End User context a network user-id or end user's device
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Clients ClientEnrichmentDetails
    description: Complete reference of the ClientEnrichmentDetails API.
    link: https://developer.cisco.com/docs/dna-center/#!client-enrichment-details
notes:
  - SDK Method used are
    clients.Clients.client_enrichment_details,
  - Paths used are
    get /dna/intent/api/v1/clientEnrichmentDetails,
"""

EXAMPLES = r"""
---
- name: Get all Client Enrichment Details V3
  cisco.catalystcenter.client_enrichment_details_v3_info:
