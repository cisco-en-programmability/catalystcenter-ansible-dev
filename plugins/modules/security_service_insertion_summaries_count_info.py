...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for SDA CountOfSecurityServiceInsertionSummaries
    description: Complete reference of the CountOfSecurityServiceInsertionSummaries API.
...
EXAMPLES = r"""
---
- name: Get all Security Service Insertion Summaries Count
