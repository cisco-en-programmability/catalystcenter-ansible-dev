...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for SDA ReadFabricSitesWithHealthSummaryFromId
  ...
  - name: Cisco Catalyst Center documentation for SDA ReadListOfFabricSitesWithTheirHealthSummary
