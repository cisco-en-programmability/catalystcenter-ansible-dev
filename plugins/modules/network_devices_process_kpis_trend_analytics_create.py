...
DOCUMENTATION = r"""
---
module: network_devices_process_kpis_trend_analytics_create
short_description: Resource module for Network Devices Process Kpis Trend Analytics Create
description:
  - Manage operation create of the resource Network Devices Process Kpis Trend Analytics Create. - > Retrieves the time series
    process kpis for group of processes in WLC by applying complex filters, aggregate functions, and grouping. The data will
    be grouped based on the specified trend time interval. If startTime and endTime are not provided, the API defaults to
    the last 24 hours. - > Retrieves the time series process kpis of a specific process in WLC by applying complex filters,
    aggregate functions, and grouping. The data will be grouped based on the specified trend time interval. If startTime and
    endTime are not provided, the API defaults to the last 24 hours.
...
options:
  aggregateAttributes:
    description: Network Devices Process Kpis Trend Analytics Create's aggregateAttributes.
    elements: dict
    suboptions:
      function:
    ...
    type: list
  attributes:
    description: Network Devices Process Kpis Trend Analytics Create's attributes.
    elements: str
    type: list
  endTime:
    ...
    type: int
  filters:
    description: Network Devices Process Kpis Trend Analytics Create's filters.
    elements: dict
    suboptions:
      filters:
    ...
    type: list
  groupBy:
    description: Network Devices Process Kpis Trend Analytics Create's groupBy.
    elements: str
    type: list
  headers:
    ...
    type: dict
  id:
    description: Id path parameter. Process Name.
    type: str
  networkDeviceId:
    description: NetworkDeviceId path parameter. Network Device UUID.
    type: str
  page:
    description: Network Devices Process Kpis Trend Analytics Create's page.
    suboptions:
      count:
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Devices RetrievesGroupOfProcessesKpisInWLCOverASpecifiedPeriodOfTime
    description: Complete reference of the RetrievesGroupOfProcessesKpisInWLCOverASpecifiedPeriodOfTime API.
    link: https://developer.cisco.com/docs/dna-center/#!retrieves-group-of-processes-kpis-in-wlc-over-a-specified-period-of-time
  - name: Cisco Catalyst Center documentation for Devices RetrievesSpecificProcessKpisForAProcessInWLCOverASpecifiedPeriodOfTime
    description: Complete reference of the RetrievesSpecificProcessKpisForAProcessInWLCOverASpecifiedPeriodOfTime API.
    link: https://developer.cisco.com/docs/dna-center/#!retrieves-specific-process-kpis-for-a-process-in-wlc-over-a-specified-period-of-time
notes:
  - SDK Method used are
    devices.Devices.retrieves_specific_process_kpis_for_a_process_in_wlc_over_a_specified_period_of_time,
  - Paths used are
    post /dna/data/api/v1/networkDevices/{networkDeviceId}/processKpis/trendAnalytics,
    post /dna/data/api/v1/networkDevices/{networkDeviceId}/processKpis/{id}/trendAnalytics,
"""

EXAMPLES = r"""
---
- name: Create
  cisco.catalystcenter.network_devices_process_kpis_trend_analytics_create:
