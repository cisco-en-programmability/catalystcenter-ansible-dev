...
DOCUMENTATION = r"""
---
module: switches_configs_deployed_security_info
short_description: Information module for Switches Configs Deployed Security
description:
  - Get Switches Configs Deployed Security by id. - > Returns deployed configuration entries for the specified security feature
...
options:
  ...
  feature:
    description:
      - >
        Feature path parameter. Name of the feature to retrieve security configuration for. The API
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Wired GetDeployedSecurityConfigurations
    description: Complete reference of the GetDeployedSecurityConfigurations API.
    link: https://developer.cisco.com/docs/dna-center/#!get-deployed-security-configurations
notes:
  - SDK Method used are
    wired.Wired.get_deployed_security_configurations,
  - Paths used are
    get /dna/campus/api/v1/switches/{id}/configs/deployed/security/{feature},
"""
