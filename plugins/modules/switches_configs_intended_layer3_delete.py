...
DOCUMENTATION = r"""
---
module: switches_configs_intended_layer3_delete
short_description: Resource module for Switches Configs Intended Layer3 Delete
description:
  - Manage operation delete of the resource Switches Configs Intended Layer3 Delete. - > This API deletes the configurations
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Wired DeleteIntendedLayer3Configurations
    description: Complete reference of the DeleteIntendedLayer3Configurations API.
    link: https://developer.cisco.com/docs/dna-center/#!delete-intended-layer-3-configurations
notes:
  - SDK Method used are
    wired.Wired.delete_intended_layer3_configurations,
  - Paths used are
    delete /dna/campus/api/v1/switches/{id}/configs/intended/layer3/{feature},
"""

EXAMPLES = r"""
---
- name: Delete by id
  cisco.catalystcenter.switches_configs_intended_layer3_delete:
