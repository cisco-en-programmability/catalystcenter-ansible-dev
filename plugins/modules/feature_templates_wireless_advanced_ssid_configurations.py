...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Wireless CreateAdvancedSSIDConfigurationFeatureTemplate
  ...
  - name: Cisco Catalyst Center documentation for Wireless DeleteAdvancedSSIDConfigurationFeatureTemplate
  ...
  - name: Cisco Catalyst Center documentation for Wireless UpdateAdvancedSSIDConfigurationFeatureTemplate
