...
DOCUMENTATION = r"""
---
module: switches_configs_intended_security_update
short_description: Resource module for Switches Configs Intended Security Update
description:
  - Manage operation update of the resource Switches Configs Intended Security Update. - > This API updates the configurations
          ...
          ipSgtMappings:
            ...
            suboptions:
              configType:
                ...
                type: str
              items:
                description: Switches Configs Intended Security Update's items.
                elements: dict
                suboptions:
                  configType:
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Wired UpdateIntendedSecurityConfigurations
    description: Complete reference of the UpdateIntendedSecurityConfigurations API.
    link: https://developer.cisco.com/docs/dna-center/#!update-intended-security-configurations
notes:
  - SDK Method used are
    wired.Wired.update_intended_security_configurations,
  - Paths used are
    put /dna/campus/api/v1/switches/{id}/configs/intended/security/{feature},
"""
