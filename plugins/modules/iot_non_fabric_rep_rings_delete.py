...
description:
  - Manage operation delete of the resource Iot Non Fabric Rep Rings Delete. - > This API deletes the REP ring configured
    in the NON-FABRIC deployment for the given id. The id of configured REP ring can be retrieved using the API `/dna/intent/api/v1/iot/repRings/query`.
version_added: '2.3.0'
...
notes:
  - SDK Method used are
    industrial_configuration.IndustrialConfiguration.delete_rep_ring_configured_in_the_non_fabric_deployment,
  - Paths used are
