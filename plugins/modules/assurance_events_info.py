...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Devices GetDetailsOfASingleAssuranceEvent
  ...
  - name: Cisco Catalyst Center documentation for Devices QueryAssuranceEvents
