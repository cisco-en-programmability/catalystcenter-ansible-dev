...
description:
  - Get all Site Kpi Summaries Top N Analytics.
  - Gets the topN analytics data for a given taskId. For detailed information.
version_added: '2.0.0'
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Sites GetTopNEntitiesRelatedToSiteAnalyticsForTheGivenTaskId
