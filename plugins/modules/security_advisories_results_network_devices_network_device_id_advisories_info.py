...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Compliance GetSecurityAdvisoriesAffectingTheNetworkDevice
  ...
  - name: Cisco Catalyst Center documentation for Compliance GetSecurityAdvisoryAffectingTheNetworkDeviceByDeviceIdAndAdvisoryId
