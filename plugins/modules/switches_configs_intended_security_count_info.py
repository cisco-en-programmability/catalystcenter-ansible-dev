...
DOCUMENTATION = r"""
---
module: switches_configs_intended_security_count_info
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Wired GetIntendedSecurityConfigCount
    description: Complete reference of the GetIntendedSecurityConfigCount API.
    link: https://developer.cisco.com/docs/dna-center/#!get-intended-security-config-count
notes:
  - SDK Method used are
    wired.Wired.get_intended_security_config_count,
  - Paths used are
    get /dna/campus/api/v1/switches/{id}/configs/intended/security/{feature}/count,
"""

EXAMPLES = r"""
---
- name: Get Switches Configs Intended Security Count by id
  cisco.catalystcenter.switches_configs_intended_security_count_info:
