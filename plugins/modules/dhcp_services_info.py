...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Devices RetrievesTheDetailsOfASpecificDHCPServiceMatchingTheIdOfTheService
  ...
  - name: Cisco Catalyst Center documentation for Devices RetrievesTheListOfDHCPServicesForGivenParameters
