...
DOCUMENTATION = r"""
---
module: wireless_controllers_stats_query_count_create
short_description: Resource module for Wireless Controllers Stats Query Count Create
description:
  - Manage operation create of the resource Wireless Controllers Stats Query Count Create. - > Retrieves the number of WLCs
...
options:
  endTime:
    ...
    type: int
  filters:
    description: Wireless Controllers Stats Query Count Create's filters.
    elements: dict
    suboptions:
      filters:
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Devices RetrievesTheNumberOfWLCsByApplyingComplexFilters
    description: Complete reference of the RetrievesTheNumberOfWLCsByApplyingComplexFilters API.
    link: https://developer.cisco.com/docs/dna-center/#!retrieves-the-number-of-wl-cs-by-applying-complex-filters
notes:
  - SDK Method used are
    devices.Devices.retrieves_the_number_of_wlcs_by_applying_complex_filters,
  - Paths used are
    post /dna/data/api/v1/wirelessControllersStats/query/count,
"""

EXAMPLES = r"""
---
- name: Create
  cisco.catalystcenter.wireless_controllers_stats_query_count_create:
