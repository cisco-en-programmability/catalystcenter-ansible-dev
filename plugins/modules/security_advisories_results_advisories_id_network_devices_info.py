...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Compliance GetSecurityAdvisoryNetworkDeviceForTheSecurityAdvisoryByNetworkDeviceId
  ...
  - name: Cisco Catalyst Center documentation for Compliance GetSecurityAdvisoryNetworkDevicesForTheSecurityAdvisory
