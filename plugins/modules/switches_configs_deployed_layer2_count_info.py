...
DOCUMENTATION = r"""
---
module: switches_configs_deployed_layer2_count_info
  ...
  feature:
    description:
      - >
        ...
        device. The device config learning must have enabled for the switch using the API
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Wired GetDeployedLayer2ConfigCount
    description: Complete reference of the GetDeployedLayer2ConfigCount API.
    link: https://developer.cisco.com/docs/dna-center/#!get-deployed-layer-2-config-count
notes:
  - SDK Method used are
    wired.Wired.get_deployed_layer2_config_count,
  - Paths used are
    get /dna/campus/api/v1/switches/{id}/configs/deployed/layer2/{feature}/count,
"""

EXAMPLES = r"""
---
- name: Get Switches Configs Deployed Layer2 Count by id
  cisco.catalystcenter.switches_configs_deployed_layer2_count_info:
