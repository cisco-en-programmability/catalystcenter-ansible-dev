...
DOCUMENTATION = r"""
---
module: wireless_controllers_intended_ssids_policy_tags_policy_tag_rlan_policies
short_description: Resource module for Wireless Controllers Intended Ssids Policy Tags Policy Tag Rlan Policies
description:
  - Manage operations create, update and delete of the resource Wireless Controllers Intended Ssids Policy Tags Policy Tag
    Rlan Policies. - > This API operation creates an intended PolicyTagRlanPolicy resource, and the subsequent "deploy" API
    call will configure the changes on the underlying wireless controller, and this API is applicable for per-device based
    configuration. - > This API operation deletes an intended PolicyTagRlanPolicy resource, and the subsequent "deploy" API
    call will configure the changes on the underlying wireless controller, and this API is applicable for per-device based
    configuration. - > This API operation updates an intended PolicyTagRlanPolicy resource, and the subsequent "deploy" API
    call will configure the changes on the underlying wireless controller, and this API is applicable for per-device based
...
options:
  id:
    description: Id path parameter. Instance UUID of the PolicyTagRlanPolicy.
    type: str
  networkDeviceId:
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Wireless CreateANewInstanceOfAnIntendedPolicyTagRlanPolicyFeatureOnAWirelessController
    description: Complete reference of the CreateANewInstanceOfAnIntendedPolicyTagRlanPolicyFeatureOnAWirelessController API.
    link: https://developer.cisco.com/docs/dna-center/#!create-a-new-instance-of-an-intended-policy-tag-rlan-policy-feature-on-a-wireless-controller
...
notes:
  - SDK Method used are
    ...
    wireless.Wireless.delete_configurations_for_a_specific_instance_of_an_intended_policy_tag_rlan_policy_feature_on_a_wireless_controller,
    wireless.Wireless.update_configurations_for_a_specific_instance_of_an_intended_policy_tag_rlan_policy_feature_on_a_wireless_controller,
  - Paths used are
    post /dna/campus/api/v1/wirelessControllers/{networkDeviceId}/intended/ssids/policyTags/{policyTagId}/policyTagRlanPolicies,
    delete /dna/campus/api/v1/wirelessControllers/{networkDeviceId}/intended/ssids/policyTags/{policyTagId}/policyTagRlanPolicies/{id},
    put /dna/campus/api/v1/wirelessControllers/{networkDeviceId}/intended/ssids/policyTags/{policyTagId}/policyTagRlanPolicies/{id},
"""

EXAMPLES = r"""
---
- name: Update by id
  cisco.catalystcenter.wireless_controllers_intended_ssids_policy_tags_policy_tag_rlan_policies:
