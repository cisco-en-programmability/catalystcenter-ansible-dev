...
description:
  ...
  - Get Energy Clients by id. - > Retrieves a list of client devices with energy data based on the specified query parameters.
    ...
    deviceEnergy_1.0-1.0.1-resolved.yaml. - > Retrieves client device energy data for a specified time range based on the
    client ID. For detailed information about the usage of the API, please refer to the Open API specification document - https
...
seealso:
  ...
  - name: Cisco Catalyst Center documentation for Clients GetClientsEnergy
