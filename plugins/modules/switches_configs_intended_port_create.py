...
DOCUMENTATION = r"""
---
module: switches_configs_intended_port_create
short_description: Resource module for Switches Configs Intended Port Create
description:
  - Manage operation create of the resource Switches Configs Intended Port Create. - > This API creates configurations for
...
options:
  ethernetInterfaceConfig:
    ...
    suboptions:
      items:
        description: Switches Configs Intended Port Create's items.
        elements: dict
        suboptions:
          accessList:
          ...
          deviceTrackingPolicy:
            ...
            suboptions:
              configType:
                description: Switches Configs Intended Port Create's configType.
                type: str
              items:
                description: Switches Configs Intended Port Create's items.
                elements: dict
...
requirements:
  ...
  - python >= 3.12
seealso:
  - name: Cisco Catalyst Center documentation for Wired AddIntendedPortConfigurations
    description: Complete reference of the AddIntendedPortConfigurations API.
    link: https://developer.cisco.com/docs/dna-center/#!add-intended-port-configurations
notes:
  - SDK Method used are
    wired.Wired.add_intended_port_configurations,
  - Paths used are
    post /dna/campus/api/v1/switches/{id}/configs/intended/port/{feature},
"""
